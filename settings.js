...
function applyTheme(theme) {
    ...
    const themes = ["oceanic", "galaxy", "gaming", "cyberpunk", "techno", "hacker", "midnight", "crimson" "halloween", "sunset", "noctura", "ruby", "light", "christmas", "fire."]; // Add "default" to the list
